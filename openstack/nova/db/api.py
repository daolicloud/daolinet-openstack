...
def group_get_by_project(context, project_id):
    return IMPL.group_get_by_project(context, project_id)

def group_get(context, id):
    return IMPL.group_get(context, id)

def group_create(context, name, description, project_id):
    return IMPL.group_create(context, name, description, project_id)

def group_delete(context, id):
    IMPL.group_delete(context, id)

def group_update(context, id, name=None, description=None):
    return IMPL.group_update(context, id, name=name,
                             description=description)

def group_member_get(context, group_id):
    return IMPL.group_member_get(context, group_id)

def group_member_create(context, group_id, instance_id):
    return IMPL.group_member_create(context, group_id, instance_id)

def group_member_delete(context, group_id, instance_id=None):
    group_member_delete(context, group_id, instance_id=instance_id)

def gateway_get_all(context):
    return IMPL.gateway_get_all(context)
