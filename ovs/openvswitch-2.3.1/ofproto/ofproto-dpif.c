                 ...
                 bool take_ref)
{
    ...
    case RULE_DPIF_LOOKUP_VERDICT_MATCH:
        //VLOG_ERR("RULE_DPIF_LOOKUP_VERDICT_MATCH");
        return table_id;
    case RULE_DPIF_LOOKUP_VERDICT_CONTROLLER: {
        struct ofport_dpif *port;
        //VLOG_ERR("RULE_DPIF_LOOKUP_VERDICT_CONTROLLER");
    ...
    case RULE_DPIF_LOOKUP_VERDICT_DROP:
        //VLOG_ERR("RULE_DPIF_LOOKUP_VERDICT_DROP");
        config = OFPUTIL_PC_NO_PACKET_IN;
        break;
    case RULE_DPIF_LOOKUP_VERDICT_DEFAULT:
        //VLOG_ERR("RULE_DPIF_LOOKUP_VERDICT_DEFAULT");
