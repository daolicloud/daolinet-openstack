...
#include "ofp-util.def"
    ...
    case OFPUTIL_OFPAT10_SET_ICMP_ID:
        //ofpact_put_SET_ICMP_ID(out)->port = ntohs(a->tp_port.tp_port);
        ofpact_put_SET_ICMP_ID(out)->port = a->tp_port.tp_port;
        break;
                        ...
                        struct ofpbuf *ofpacts)
{
    ...
    //VLOG_ERR("---------------------set_field_from_openflow---------------------------");
    ...
    //VLOG_ERR("oxm_header: %x", oxm_header);
    ...
    //VLOG_ERR("mf->id:mf-name:value  %d:%s:%08x", mf->id, mf->name, sf->value.be32);
    //VLOG_ERR("---------------------set_field_from_openflow---------------------------\n");
                        ...
                        enum ofp_version version)
{
    ...
    char *value;
    //VLOG_ERR("--------set_field_to_openflow12---------\n");
...
#include "ofp-util.def"
    ...
    case OFPUTIL_OFPAT11_GROUP:
        ...
        break;
    //daolicloud
    case OFPUTIL_OFPAT11_SET_ICMPV4_ID:
        //VLOG_ERR("-------------------fix me daolicloud----------------------");
        break;
...
ofpact_to_openflow10(const struct ofpact *a, struct ofpbuf *out)
{
    ...
    /* add by changzhi */
    case OFPACT_SET_ICMP_ID:
        ofputil_put_OFPAT10_SET_ICMP_ID(out)->tp_port
            = htons(ofpact_get_SET_ICMP_ID(a)->port);
        break;
        break;
...
ofpact_format(const struct ofpact *a, struct ds *s)
{
    ...
    // add by ljx
    case OFPACT_SET_ICMP_ID:
        ds_put_format(s, "mod_icmp_identify:%d", ofpact_get_SET_ICMP_ID(a)->port);
        break;
