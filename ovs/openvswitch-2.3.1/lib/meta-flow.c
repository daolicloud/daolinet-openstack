...
#error
    ...
    //add by ljx
    {
        MFF_ICMPV4_IDENTIFY, "icmp_identify", NULL,
        MF_FIELD_SIZES(be16),
        MFM_NONE,               
        MFS_DECIMAL,            
        MFP_ICMPV4,
        true,
        //NXM_OF_ICMP_IDENTIFY, "NXM_OF_ICMP_IDENTIFY", 
        //NXM_OF_ICMP_IDENTIFY, "NXM_OF_ICMP_IDENTIFY", 
        OXM_OF_ICMPV4_ID, "OXM_OF_ICMPV4_ID",
        OXM_OF_ICMPV4_ID, "OXM_OF_ICMPV4_ID",
        OFP12_VERSION,
        OFPUTIL_P_ANY,
        OFPUTIL_P_NXM_OXM_ANY,
...
nxm_do_init(void)
{
    ...
    for (i = 0; i < MFF_N_IDS; i++) {
        ...
        if (MFF_ICMPV4_IDENTIFY == mf->id)
            //VLOG_ERR("name:id(MFF_ICMPV4_IDENTIFY):nxm_header: %s:%d:%x",
            //         mf->name, mf->id, mf->nxm_header);
